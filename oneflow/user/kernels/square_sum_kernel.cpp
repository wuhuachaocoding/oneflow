...
class SquareSumKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
...
template<DeviceType device_type, typename T>
class MultiSquareSumKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
