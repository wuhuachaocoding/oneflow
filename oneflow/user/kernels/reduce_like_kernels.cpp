...
class ReduceSumLikeOpKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
...
class ReduceSumLikeHalfKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
