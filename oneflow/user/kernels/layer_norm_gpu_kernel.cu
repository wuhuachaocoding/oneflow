...
template<typename T, typename BNParamT>
class LayerNormGradGpuKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
...
template<typename T>
class LayerNormParamGradGpuKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
...
class LayerNormParamGradGpuHalfKernel final : public user_op::OpKernel, public CudaGraphSupport {
 public:
