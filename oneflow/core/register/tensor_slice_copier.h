...
class TensorSliceCopier final {
 public:
  ...
  void Copy(StreamContext* stream_ctx, const primitive::MemoryCopyNd& copier, void* dst,
            const void* src) const;
  void Copy(StreamContext* stream_ctx, const primitive::MemoryCopyNd& copier, Blob* dst_blob,
